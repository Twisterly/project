...
public class CreateAppOrderFromCarListController {
    ...
    public ModelAndView showCreateAppOrderPage(String carId) {
        Car car = carService.getById(carId);
        UserExt principal =
                (UserExt) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        ModelAndView modelAndView = new ModelAndView("createAppOrderFromCarList");
    ...
    public ModelAndView createAppOrder(AppOrder appOrder, String carId) {
