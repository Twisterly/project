  ...
  <c:if test="${currentPage + 1 == pageCount && pageCount == 1}">
    ...
    <c:if test="${currentPage + 1 == 1 && currentPage + 1 < pageCount}">
      <li class="page-item disabled">
        ...
        <li class="page-item"><a class="page-link" href="guest-car-list.html?pageNumber=${currentPage + 1}">Next</a></li>
    </c:if>
    <c:if test="${currentPage + 1 > 1 && currentPage + 1 < pageCount}">
      <li class="page-item"><a class="page-link" href="guest-car-list.html?pageNumber=${currentPage - 1}">Previous</a></li>
      <li class="page-item"><a class="page-link" href="guest-car-list.html?pageNumber=${currentPage + 1}">Next</a></li>
    </c:if>
