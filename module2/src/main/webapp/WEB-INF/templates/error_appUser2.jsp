...
<form method="post" action="/car/reg-appUser.html">
  ...
  <div class="col-md-6">
     ...
     <input value="${appUser.username}" name="username" class="form-control" id="username" aria-describedby="nameHelp" required>
    </div>
  </div>
    <!-- password -->
     <div class="col-md-6">
      <label for="password" class="form-label">Password</label>
      <input value="${appUser.password}" name="password" class="form-control" id="{noop}password" aria-describedby="nameHelp" required>
      <div id="nameHelp" class="form-text">Enter password</div>
     </div>
     <!-- firstName -->
      <div class="col-md-6">
        <label for="firstName" class="form-label">first Name</label>
        <input value="${appUser.firstName}" name="firstName" class="form-control" id="firstName" aria-describedby="nameHelp" pattern="^[A-Z]{1}[a-z]{1,15}$">
        <div id="nameHelp" class="form-text">Enter firstName</div>
      </div>
       <!-- lastName -->
          <div class="col-md-6">
           <label for="lastName" class="form-label">last Name</label>
           <input value="${appUser.lastName}" name="lastName" class="form-control" id="lastName" aria-describedby="nameHelp" pattern="^[A-Z]{1}[a-z]{1,15}$">
...
<br/>
 <!-- birthDat -->
  <div class="col-md-2">
    ...
    <input value="${appUser.birthDate}" name="birthDate" class="form-control" id="birthDate" aria-describedby="nameHelp">
